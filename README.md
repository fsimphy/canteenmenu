# canteenmenu
[![Travis CI status](https://travis-ci.org/fsimphy/canteenmenu.svg?branch=develop)](https://travis-ci.org/fsimphy/canteenmenu)
[![codecov](https://codecov.io/gh/fsimphy/canteenmenu/branch/develop/graph/badge.svg)](https://codecov.io/gh/fsimphy/canteenmenu)
...
```
git clone https://github.com/fsimphy/canteenmenu.git
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/fsimphy/canteenmenu/tags). 
...
See also the list of [contributors](https://github.com/fsimphy/canteenmenu/contributors) who participated in this project.
